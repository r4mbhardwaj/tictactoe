...
size = width, height = 600, 400 # set window size
...
user = None # Global variable that holds the user's name
board = ttt.initial_state() # create a new board
ai_turn = False # if it's the ai's turn or not
